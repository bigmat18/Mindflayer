...
- Weights are $\omega_i \in \mathbb{R}$
- RBF is a function $\varphi: \mathbb{R} \to \mathbb{R}$,
- p is a polynome.
...
- $\varphi(d) = d²$, linear polynomial
- $\varphi(d) = d³$, linear / quadratic polynomial 
- $\varphi(d) = d² \log(d)$, linear / quadratic polynomial

##### Example
![[Pasted image 20250911173519.png | 500]]

![[Pasted image 20250911173540.png | 500]]
# References
- [Reconstruction and Representation of 3D Objects with Radial Basis Functions](https://www.cs.jhu.edu/~misha/Fall05/Papers/carr01.pdf)