...
The conversion from parametric surface to implicit can be done very efficiently by **[[Parallel Surface and Solid Voxelization on GPUs|voxelization]]** or **3D scan-conversions** but the result is piecewise constant, this because a surface is not smooth everywhere and a piecewise linear or trilinear approximation seems to be the best compromise between accuracy and efficiency.
