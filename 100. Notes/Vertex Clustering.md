...
$$
the resulint error is measure is called the **[[Quadratics Error]] Metrics (QEM)**. The optimal position x minimizing the quadrati error can be computed as the solution of the least square system:
$$
