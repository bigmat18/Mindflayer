...
#### Uniform Laplacian
This is a uniform discretization of the [[Divergence and Laplacian#Laplacian|Laplacian-beltrami]] operator
...
#### Cotangent formula 
A more accurate discretization of the [[Divergence and Laplacian#Laplacian|laplacian-beltrami]] operator can be derived using a mixed finite elment/finit volume method.
