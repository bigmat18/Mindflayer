...
### 1. The Core Idea: "Smoothing" the Function
...
_(Note: Non-differentiability occurs because multiple vectors $z$ can be optimal for a single $x$, leading to many different subgradients $A\overline{z} \in \partial f(x)$)_.
...
### 2. Mathematically Speaking: Analysis of Smoothed Gradient
...
### 3. Practical Reality: The "Consistently Slowish" Behavior
