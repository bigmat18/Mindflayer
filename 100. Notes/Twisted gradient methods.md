...
Because the cosine of 45 degrees is a positive number (about 0.707), the final result remains strictly negative. The direction still points "downhill". Consequently, the convergence proofs we have seen so far carry forward largely unchanged.
