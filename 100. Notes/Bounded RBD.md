...
- The value of f is determined only locally (withing the radius 1). Use $\varphi\left( \frac{d}{R} \right)$ to adapt to the point cloud resolution. 
...
More issues:
• Still hard to represent sharp features, anisotropic basis functions may be used.
# References