...
**Repository**: https://github.com/bigmat18/cuda-mesh-voxelization

**Other link**: [Presentation](https://www.canva.com/design/DAGtctetbj0/ZMeEuIOAW2boftsXtSnLZQ/edit?utm_content=DAGtctetbj0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton)

# CSG on Mesh using Voxelization and SDF
...
In this stage, the n voxel grids generated by the voxelization process are combined using the selected Constructive Solid Geometry (CSG) operations, which are applied as voxel-wise Boolean operations.
- **Input**: n voxel grids composed of binary values (0 and 1)
- **Output**: a single voxel grid resulting from the input grids after applying the chosen CSG operations
