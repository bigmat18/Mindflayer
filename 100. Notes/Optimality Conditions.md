...
2. **The first-order model is a global underestimator:**
...
If $f \in C^2$, convexity is completely determined by the Hessian matrix:
...
## 3. Mathematically speaking: Basic convex functions
...
*Exercise Note: Is $f(x) = \min\{x_1, ..., x_n\}$ convex? No. If we evaluate it on the line $x_1 + x_2 = 0 \equiv x_2 = -x_1$, we get $\min\{x_1, -x_1\} = -|x_1|$, which is clearly concave.*

---

## 4. Mathematically speaking: Convexity-preserving operations
